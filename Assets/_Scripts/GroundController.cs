/* Filename: GroundController.cs
 * Author: Vladislav Ostrikov
 * Last modified by: Vladislav Ostrikov
 * Last modified: Oct 2, 2019
 * This script is used on the Ground object to move it left and then return it back to right
 */
...
public class GroundController : MonoBehaviour
{
    ...
    //PRIVATE variables
    private float m_leftPositionReset = 0.28f; // Is float number representing left reset position of this object
    private float m_rightPositionReset = 3.0f; // Is float number representing right reset position of this object
