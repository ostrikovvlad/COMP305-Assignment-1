/* Filename: Forest2Controller.cs
 * Author: Vladislav Ostrikov
 * Last modified by: Vladislav Ostrikov
 * Last modified: Oct 2, 2019
 * This script is used on the Forest2 object to move it left and then return it back to right
 */
using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class Forest2Controller : MonoBehaviour
{
    //PUBLIC variables
    ...
    //PRIVATE variables
    private float m_leftPositionReset = 2.36f; // Is float number representing left reset position of this object
    private float m_rightPositionReset = 3.86f; // Is float number representing right reset position of this object
    ...
    void Reset()
    {
        ...
        if (m_isFirstRun)
        {
            resetPosition.x = (resetToLeftPosition) ? m_leftPositionReset : m_rightPositionReset;
